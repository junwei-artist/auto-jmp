...
export default function AnalysisForm() {
  ...
  const validateMutation = useMutation({
    mutationFn: async (file: File) => {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v1/extensions/excel2boxplotv1/validate`, {
        method: 'POST',
        body: formData
      })
  ...
  const processMutation = useMutation({
    mutationFn: async (file: File) => {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v1/extensions/excel2boxplotv1/create-project`, {
        method: 'POST',
        body: formData
      })
          ...
          <div className="flex space-x-4">
            ...
            {currentStep === 'process' && (
              <Button 
                ...
                className="flex-1"
              >
                {processMutation.isPending ? 'Processing...' : 'Create Project & Process'}
              </Button>
            )}
