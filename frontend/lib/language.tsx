...
const translations = {
  en: {
    ...
    'home.carousel.allFunctions.description': 'Discover our comprehensive suite of tools for data visualization, organization, automation, and analysis',
    'home.carousel.allFunctions.cta': 'Get Started',
    'home.carousel.allFunctions.clickToStart': 'Click on any function above to get started',
    'home.carousel.dashboard.title': 'JMP Visualization Dashboard',
    'home.carousel.dashboard.subtitle': 'Transform Data into Insights',
    'home.carousel.dashboard.description': 'Create powerful visualizations and analyze your data with advanced JMP tools',
    'home.carousel.workspaces.title': 'Organize Your Workspaces',
    'home.carousel.workspaces.subtitle': 'Categorize and Manage Tasks',
    'home.carousel.workspaces.description': 'Create organized workspaces to structure your projects and workflows efficiently',
    'home.carousel.workflows.title': 'Automate with Workflows',
    'home.carousel.workflows.subtitle': 'Node-Based Automation',
    'home.carousel.workflows.description': 'Build powerful automated workflows using visual node-based programming',
    'home.carousel.modules.title': 'Data Analysis Modules',
    ...
    'home.portal.dashboard.title': 'Dashboard',
    'home.portal.dashboard.description': 'JMP Visualization - Transform your data into powerful insights and visualizations',
    'home.portal.dashboard.cta': 'Explore Dashboard',
    'home.portal.workspaces.title': 'Workspaces',
    'home.portal.workspaces.description': 'Organize and categorize your tasks, projects, and workflows efficiently',
    'home.portal.workspaces.cta': 'View Workspaces',
    'home.portal.workflows.title': 'Workflows',
    'home.portal.workflows.description': 'Automate processes with visual node-based workflow automation',
    'home.portal.workflows.cta': 'Create Workflow',
    ...
    'powerpoint.wizard.back': 'Back',
    'powerpoint.wizard.existingPresentations': 'Existing Presentations',
    'powerpoint.wizard.viewOrEdit': 'View or edit previously generated presentations',
    'powerpoint.wizard.hide': 'Hide',
    'powerpoint.wizard.show': 'Show',
    'powerpoint.wizard.slides': 'slides',
    'powerpoint.wizard.open': 'Open',
    'powerpoint.wizard.delete': 'Delete',
    'powerpoint.wizard.prepareWorkspace': 'Prepare Workspace',
    'powerpoint.wizard.prepareDescription': 'This will create a workspace folder and copy Excel files, run images, and drawing folders.',
    'powerpoint.wizard.drawingFolders': 'Drawing Folders (Optional)',
    'powerpoint.wizard.addDrawingFolder': 'Add drawing folder (optional)',
    'powerpoint.wizard.remove': 'Remove',
    'powerpoint.wizard.clearAll': 'Clear All',
    'powerpoint.wizard.willBeCopied': 'What will be copied to workspace:',
    'powerpoint.wizard.excelFile': 'Excel file from the run',
    'powerpoint.wizard.runTaskImages': 'Run task images',
    'powerpoint.wizard.drawingFoldersCount': '{count} drawing folder{plural} (drawings_1, drawings_2, etc.)',
    'powerpoint.wizard.preparingWorkspace': 'Preparing Workspace...',
    ...
    'powerpoint.editor.back': 'Back',
    'powerpoint.editor.generatePowerPoint': 'Generate PowerPoint',
    'powerpoint.editor.generating': 'Generating...',
    'powerpoint.editor.excelSettings': 'Excel Settings',
    'powerpoint.editor.sheet': 'Sheet',
    'powerpoint.editor.titleColumn': 'Title Column',
    'powerpoint.editor.descriptionColumn': 'Description Column',
    'powerpoint.editor.matchColumn': 'Match Column',
    'powerpoint.editor.none': 'None',
    'powerpoint.editor.layoutElements': 'Layout Elements',
    'powerpoint.editor.addImage': 'Add Image',
    'powerpoint.editor.addText': 'Add Text',
    'powerpoint.editor.titleLabel': 'Title',
    'powerpoint.editor.description': 'Description',
    'powerpoint.editor.text': 'Text',
    'powerpoint.editor.runImage': 'Run Image',
    'powerpoint.editor.drawingImage': 'Drawing Image',
    'powerpoint.editor.extraImage': 'Extra Image',
    'powerpoint.editor.positionX': 'X',
    'powerpoint.editor.positionY': 'Y',
    'powerpoint.editor.width': 'W',
    'powerpoint.editor.height': 'H',
    'powerpoint.editor.fontSize': 'Font Size',
    'powerpoint.editor.color': 'Color',
    'powerpoint.editor.column': 'Column',
    'powerpoint.editor.select': 'Select',
    'powerpoint.editor.bold': 'Bold',
    'powerpoint.editor.maintainAspectRatio': 'Maintain Aspect Ratio',
    'powerpoint.editor.canvasInfo': 'Canvas: 10" × 7.5" • Drag to move • Drag corners to resize',
    'powerpoint.editor.downloadSection': 'Generated Presentations',
    ...
    'powerpoint.messages.presentationDeleted': 'Presentation deleted successfully',
    'powerpoint.messages.presentationDeleteFailed': 'Failed to delete presentation',
    ...
    'drawing.createFromPdf.pdfUpload': 'PDF Upload',
    'drawing.createFromPdf.pdfUploadDesc': 'The system will automatically detect FAI labels and create the first layer of annotations',
    'drawing.createFromPdf.pdfFile': 'PDF File *',
    'drawing.createFromPdf.selected': 'Selected:',
    'drawing.createFromPdf.descriptionLabel': 'Description (Optional)',
    'drawing.createFromPdf.descriptionPlaceholder': 'Enter folder description...',
    'drawing.createFromPdf.processing': 'Processing PDF and extracting annotations...',
    'drawing.createFromPdf.processButton': 'Process PDF and Continue to Annotation Editor',
    ...
    'annotation.editor.noAnnotations': 'No annotations found',
    'annotation.editor.completed': 'completed',
    'annotation.editor.saving': 'Saving...',
    'annotation.editor.save': 'Save',
    'annotation.editor.generating': 'Generating...',
    'annotation.editor.generate': 'Generate',
    'annotation.editor.generateTooltip': 'Generate cropped images from annotations',
    'annotation.editor.editAnnotation': 'Edit Annotation',
    'annotation.editor.liveParameters': 'Live Parameters',
    'annotation.editor.faiX1': 'FAI x1',
    'annotation.editor.faiY1': 'FAI y1',
    'annotation.editor.faiX2': 'FAI x2',
    'annotation.editor.faiY2': 'FAI y2',
    'annotation.editor.faiW': 'FAI w',
    'annotation.editor.faiH': 'FAI h',
    'annotation.editor.regionX': 'Region x',
    'annotation.editor.regionY': 'Region y',
    'annotation.editor.regionW': 'Region w',
    'annotation.editor.regionH': 'Region h',
    'annotation.editor.label': 'Label',
    'annotation.editor.boundingBox': 'Bounding Box (x1, y1, x2, y2)',
    'annotation.editor.saveChanges': 'Save Changes',
    'annotation.editor.delete': 'Delete',
    'annotation.editor.instructions': 'Instructions',
    'annotation.editor.instruction1': 'Red box: first layer (auto-detected)',
    'annotation.editor.instruction2': 'Blue box: second layer (draw to crop region)',
    'annotation.editor.instruction3': 'Use inputs to rename or adjust the red box',
    'annotation.editor.page': 'Page:',
    'annotation.editor.annotation': 'Annotation:',
    'annotation.editor.region': 'Region',
    'annotation.editor.fai': 'FAI',
    'annotation.editor.pan': 'Pan',
    'annotation.editor.holdSpace': 'Hold Space or Middle-Click to pan',
    'annotation.editor.regionPreview': 'Region Preview',
    'annotation.editor.hide': 'Hide',
    'annotation.editor.showRegionPreview': 'Show Region Preview',
    'annotation.editor.faiAnnotation': 'FAI Annotation',
    'annotation.editor.location': 'Location',
    'annotation.editor.size': 'Size:',
    'annotation.editor.labelPlaceholder': 'Enter label...',
    'annotation.editor.confirm': '✓ Confirm',
    'annotation.editor.cancel': '✕ Cancel',
    'annotation.editor.clickDrag': 'Click and drag to move • Drag corners to resize',
    'annotation.editor.addNewLabel': 'Add New Label',
    'annotation.editor.addNewLabelDesc': 'Enter a custom label name for the selected FAI bubble location.',
    'annotation.editor.labelName': 'Label Name',
    'annotation.editor.labelNamePlaceholder': 'e.g., FAI 12, FAI-1, Custom Label',
    'annotation.editor.addNewLabelMode': 'Click and drag on the canvas to select FAI bubble location',
    'annotation.editor.saveSuccess': 'Annotations saved successfully!',
    'annotation.editor.saveFailed': 'Failed to save annotations',
    'annotation.editor.generateSuccess': 'Output images generated successfully!',
    'annotation.editor.generateFailed': 'Failed to generate output',
    'annotation.editor.faiUpdated': 'FAI updated successfully',
    'annotation.editor.deleted': 'Deleted',
    'annotation.editor.loadFailed': 'Failed to load annotations',
    'annotation.editor.newLabelAdded': 'New label "{label}" added',
    'annotation.editor.pleaseEnterLabel': 'Please enter a label name',
    'annotation.editor.waitForImage': 'Please wait for image to load',
    ...
    'drawings.subtitle': 'Manage drawing folders and upload images to organize your project drawings',
    'drawings.createFromPdf': 'Create from PDF',
    'drawings.newFolder': 'New Drawing Folder',
    'drawings.createFolder': 'Create New Drawing Folder',
    'drawings.createFolderDesc': 'Create a new folder to organize your drawings. You can upload images to this folder later.',
    'drawings.description': 'Description',
    'drawings.descriptionPlaceholder': 'Enter folder description...',
    'drawings.creating': 'Creating...',
    'drawings.createFolderButton': 'Create Folder',
    'drawings.loading': 'Loading drawing folders...',
    'drawings.noFolders': 'No drawing folders yet',
    'drawings.createFirstFolder': 'Create Your First Folder',
    'drawings.createdBy': 'Created by',
    'drawings.image': 'image',
    'drawings.images': 'images',
    'drawings.view': 'View',
    'drawings.editAnnotations': 'Edit Annotations',
    'drawings.imagesInFolder': 'Images in this folder',
    'drawings.uploadImages': 'Upload Images',
    'drawings.loadingImages': 'Loading images...',
    'drawings.noImages': 'No images in this folder yet',
    'drawings.uploading': 'Uploading images...',
    'drawings.enterDescription': 'Please enter a description',
    'drawings.folderCreated': 'Drawing folder created successfully!',
    'drawings.folderUpdateFailed': 'Failed to update folder',
    'drawings.folderUpdated': 'Folder description updated successfully!',
    'drawings.deleteConfirm': 'Are you sure you want to delete this drawing folder and all its images? This action cannot be undone.',
    'drawings.folderDeleted': 'Drawing folder deleted successfully!',
    'drawings.folderDeleteFailed': 'Failed to delete folder',
    'drawings.loadFailed': 'Failed to load drawing folders',
    'drawings.imageUploadFailed': 'Failed to upload images',
    'drawings.onlyImages': 'Only image files are allowed',
    'drawings.uploadSuccess': 'Successfully uploaded {count} image{plural}!',
    'drawings.uploadError': 'Failed to upload {count} image{plural}',
    'drawings.imageDeleteConfirm': 'Are you sure you want to delete this image?',
    'drawings.imageDeleted': 'Image deleted successfully!',
    'drawings.imageDeleteFailed': 'Failed to delete image',
    'drawings.createFailed': 'Failed to create folder',
    'drawings.loadImagesFailed': 'Failed to load images',
    'drawings.folderDefaultName': 'Drawing Folder',
    'drawings.downloadZip': 'Download ZIP',
  ...
  zh: {
    ...
    'home.carousel.allFunctions.description': '发现我们全面的工具套件，用于数据可视化、组织、自动化和分析',
    'home.carousel.allFunctions.cta': '开始使用',
    'home.carousel.allFunctions.clickToStart': '点击上方任意功能开始使用',
    'home.carousel.dashboard.title': 'JMP可视化仪表板',
    'home.carousel.dashboard.subtitle': '将数据转化为洞察',
    'home.carousel.dashboard.description': '使用先进的JMP工具创建强大的可视化并分析您的数据',
    'home.carousel.workspaces.title': '组织您的工作空间',
    'home.carousel.workspaces.subtitle': '分类和管理任务',
    'home.carousel.workspaces.description': '创建有序的工作空间，高效地组织您的项目和工作流',
    'home.carousel.workflows.title': '使用工作流自动化',
    'home.carousel.workflows.subtitle': '基于节点的自动化',
    'home.carousel.workflows.description': '使用可视化基于节点的编程构建强大的自动化工作流',
    'home.carousel.modules.title': '数据分析模块',
    ...
    'home.portal.dashboard.title': '仪表板',
    'home.portal.dashboard.description': 'JMP可视化 - 将您的数据转化为强大的洞察和可视化',
    'home.portal.dashboard.cta': '探索仪表板',
    'home.portal.workspaces.title': '工作空间',
    'home.portal.workspaces.description': '高效地组织和管理您的任务、项目和工作流',
    'home.portal.workspaces.cta': '查看工作空间',
    'home.portal.workflows.title': '工作流',
    ...
    'powerpoint.wizard.back': '返回',
    'powerpoint.wizard.existingPresentations': '现有演示文稿',
    'powerpoint.wizard.viewOrEdit': '查看或编辑之前生成的演示文稿',
    'powerpoint.wizard.hide': '隐藏',
    'powerpoint.wizard.show': '显示',
    'powerpoint.wizard.slides': '张幻灯片',
    'powerpoint.wizard.open': '打开',
    'powerpoint.wizard.delete': '删除',
    'powerpoint.wizard.prepareWorkspace': '准备工作区',
    'powerpoint.wizard.prepareDescription': '这将创建一个工作区文件夹并复制Excel文件、运行图片和绘图文件夹。',
    'powerpoint.wizard.drawingFolders': '绘图文件夹（可选）',
    'powerpoint.wizard.addDrawingFolder': '添加绘图文件夹（可选）',
    'powerpoint.wizard.remove': '移除',
    'powerpoint.wizard.clearAll': '全部清除',
    'powerpoint.wizard.willBeCopied': '将复制到工作区的内容：',
    'powerpoint.wizard.excelFile': '运行中的Excel文件',
    'powerpoint.wizard.runTaskImages': '运行任务图片',
    'powerpoint.wizard.drawingFoldersCount': '{count} 个绘图文件夹（drawings_1、drawings_2等）',
    'powerpoint.wizard.preparingWorkspace': '正在准备工作区...',
    ...
    'powerpoint.editor.back': '返回',
    'powerpoint.editor.generatePowerPoint': '生成PowerPoint',
    'powerpoint.editor.generating': '正在生成...',
    'powerpoint.editor.excelSettings': 'Excel设置',
    'powerpoint.editor.sheet': '工作表',
    'powerpoint.editor.titleColumn': '标题列',
    'powerpoint.editor.descriptionColumn': '描述列',
    'powerpoint.editor.matchColumn': '匹配列',
    'powerpoint.editor.none': '无',
    'powerpoint.editor.layoutElements': '布局元素',
    'powerpoint.editor.addImage': '添加图片',
    'powerpoint.editor.addText': '添加文本',
    'powerpoint.editor.titleLabel': '标题',
    'powerpoint.editor.description': '描述',
    'powerpoint.editor.text': '文本',
    'powerpoint.editor.runImage': '运行图片',
    'powerpoint.editor.drawingImage': '绘图图片',
    'powerpoint.editor.extraImage': '额外图片',
    'powerpoint.editor.positionX': 'X',
    'powerpoint.editor.positionY': 'Y',
    'powerpoint.editor.width': '宽度',
    'powerpoint.editor.height': '高度',
    'powerpoint.editor.fontSize': '字体大小',
    'powerpoint.editor.color': '颜色',
    'powerpoint.editor.column': '列',
    'powerpoint.editor.select': '选择',
    'powerpoint.editor.bold': '粗体',
    'powerpoint.editor.maintainAspectRatio': '保持宽高比',
    'powerpoint.editor.canvasInfo': '画布: 10" × 7.5" • 拖动以移动 • 拖动角落以调整大小',
    'powerpoint.editor.downloadSection': '生成的演示文稿',
    ...
    'powerpoint.messages.presentationDeleted': '演示文稿删除成功',
    'powerpoint.messages.presentationDeleteFailed': '删除演示文稿失败',
    ...
    'drawing.createFromPdf.pdfUpload': 'PDF上传',
    'drawing.createFromPdf.pdfUploadDesc': '系统将自动检测FAI标签并创建第一层标注',
    'drawing.createFromPdf.pdfFile': 'PDF文件 *',
    'drawing.createFromPdf.selected': '已选择：',
    'drawing.createFromPdf.descriptionLabel': '描述（可选）',
    'drawing.createFromPdf.descriptionPlaceholder': '输入文件夹描述...',
    'drawing.createFromPdf.processing': '正在处理PDF并提取标注...',
    'drawing.createFromPdf.processButton': '处理PDF并继续到标注编辑器',
    ...
    'annotation.editor.noAnnotations': '未找到标注',
    'annotation.editor.completed': '已完成',
    'annotation.editor.saving': '正在保存...',
    'annotation.editor.save': '保存',
    'annotation.editor.generating': '正在生成...',
    'annotation.editor.generate': '生成',
    'annotation.editor.generateTooltip': '从标注生成裁剪图片',
    'annotation.editor.editAnnotation': '编辑标注',
    'annotation.editor.liveParameters': '实时参数',
    'annotation.editor.faiX1': 'FAI x1',
    'annotation.editor.faiY1': 'FAI y1',
    'annotation.editor.faiX2': 'FAI x2',
    'annotation.editor.faiY2': 'FAI y2',
    'annotation.editor.faiW': 'FAI 宽度',
    'annotation.editor.faiH': 'FAI 高度',
    'annotation.editor.regionX': '区域 x',
    'annotation.editor.regionY': '区域 y',
    'annotation.editor.regionW': '区域 宽度',
    'annotation.editor.regionH': '区域 高度',
    'annotation.editor.label': '标签',
    'annotation.editor.boundingBox': '边界框 (x1, y1, x2, y2)',
    'annotation.editor.saveChanges': '保存更改',
    'annotation.editor.delete': '删除',
    'annotation.editor.instructions': '说明',
    'annotation.editor.instruction1': '红色框：第一层（自动检测）',
    'annotation.editor.instruction2': '蓝色框：第二层（绘制以裁剪区域）',
    'annotation.editor.instruction3': '使用输入框重命名或调整红色框',
    'annotation.editor.page': '页面：',
    'annotation.editor.annotation': '标注：',
    'annotation.editor.region': '区域',
    'annotation.editor.fai': 'FAI',
    'annotation.editor.pan': '平移',
    'annotation.editor.holdSpace': '按住空格键或中键点击以平移',
    'annotation.editor.regionPreview': '区域预览',
    'annotation.editor.hide': '隐藏',
    'annotation.editor.showRegionPreview': '显示区域预览',
    'annotation.editor.faiAnnotation': 'FAI标注',
    'annotation.editor.location': '位置',
    'annotation.editor.size': '大小：',
    'annotation.editor.labelPlaceholder': '输入标签...',
    'annotation.editor.confirm': '✓ 确认',
    'annotation.editor.cancel': '✕ 取消',
    'annotation.editor.clickDrag': '点击并拖动以移动 • 拖动角落以调整大小',
    'annotation.editor.addNewLabel': '添加新标签',
    'annotation.editor.addNewLabelDesc': '为选定的FAI气泡位置输入自定义标签名称。',
    'annotation.editor.labelName': '标签名称',
    'annotation.editor.labelNamePlaceholder': '例如：FAI 12、FAI-1、自定义标签',
    'annotation.editor.addNewLabelMode': '在画布上点击并拖动以选择FAI气泡位置',
    'annotation.editor.saveSuccess': '标注保存成功！',
    'annotation.editor.saveFailed': '保存标注失败',
    'annotation.editor.generateSuccess': '输出图片生成成功！',
    'annotation.editor.generateFailed': '生成输出失败',
    'annotation.editor.faiUpdated': 'FAI更新成功',
    'annotation.editor.deleted': '已删除',
    'annotation.editor.loadFailed': '加载标注失败',
    'annotation.editor.newLabelAdded': '新标签"{label}"已添加',
    'annotation.editor.pleaseEnterLabel': '请输入标签名称',
    'annotation.editor.waitForImage': '请等待图片加载',
    ...
    'drawings.subtitle': '管理绘图文件夹并上传图片以组织您的项目绘图',
    'drawings.createFromPdf': '从PDF创建',
    'drawings.newFolder': '新建绘图文件夹',
    'drawings.createFolder': '创建新绘图文件夹',
    'drawings.createFolderDesc': '创建一个新文件夹来组织您的绘图。您可以稍后上传图片到此文件夹。',
    'drawings.description': '描述',
    'drawings.descriptionPlaceholder': '输入文件夹描述...',
    'drawings.creating': '正在创建...',
    'drawings.createFolderButton': '创建文件夹',
    'drawings.loading': '正在加载绘图文件夹...',
    'drawings.noFolders': '暂无绘图文件夹',
    'drawings.createFirstFolder': '创建您的第一个文件夹',
    'drawings.createdBy': '创建者',
    'drawings.image': '张图片',
    'drawings.images': '张图片',
    'drawings.view': '查看',
    'drawings.editAnnotations': '编辑标注',
    'drawings.imagesInFolder': '此文件夹中的图片',
    'drawings.uploadImages': '上传图片',
    'drawings.loadingImages': '正在加载图片...',
    'drawings.noImages': '此文件夹中暂无图片',
    'drawings.uploading': '正在上传图片...',
    'drawings.enterDescription': '请输入描述',
    'drawings.folderCreated': '绘图文件夹创建成功！',
    'drawings.folderUpdateFailed': '更新文件夹失败',
    'drawings.folderUpdated': '文件夹描述更新成功！',
    'drawings.deleteConfirm': '您确定要删除此绘图文件夹及其所有图片吗？此操作无法撤销。',
    'drawings.folderDeleted': '绘图文件夹删除成功！',
    'drawings.folderDeleteFailed': '删除文件夹失败',
    'drawings.loadFailed': '加载绘图文件夹失败',
    'drawings.imageUploadFailed': '上传图片失败',
    'drawings.onlyImages': '仅允许图片文件',
    'drawings.uploadSuccess': '成功上传 {count} 张图片！',
    'drawings.uploadError': '上传 {count} 张图片失败',
    'drawings.imageDeleteConfirm': '您确定要删除此图片吗？',
    'drawings.imageDeleted': '图片删除成功！',
    'drawings.imageDeleteFailed': '删除图片失败',
    'drawings.createFailed': '创建文件夹失败',
    'drawings.loadImagesFailed': '加载图片失败',
    'drawings.folderDefaultName': '绘图文件夹',
    'drawings.downloadZip': '下载ZIP',
