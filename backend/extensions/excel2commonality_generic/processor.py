"""
Main Processor Module for Excel2Commonality-Generic Plugin
...
class ExcelToCommonalityGenericProcessor:
    ...
    def validate_excel_structure(self, file_path: str, sheet_name: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                result = self.analyzer.validate_excel_structure(file_path, sheet_name)
                return result
            except Exception as e:
                error_msg = str(e)
                if "expected <class 'int'>" in error_msg or "xWindow" in error_msg or "yWindow" in error_msg:
                    ...
                    if fix_result["success"]:
                        ...
                        try:
                            result = self.analyzer.validate_excel_structure(fix_result["fixed_file"], sheet_name)
    ...
    def validate_data_content(self, file_path: str, sheet_name: Optional[str] = None) -> Dict[str, Any]:
        ...
        """
        try:
            result = self.analyzer.validate_data_content(file_path, sheet_name)
            return result
    ...
    def process_excel_file(self, file_path: str, categorical_columns: List[str], 
        ...
        try:
            # Run analysis
            analysis_result = self.analyzer.analyze_excel_file(
                file_path, categorical_columns, sheet_name=sheet_name
            )
            ...
            return {
                ...
                "details": {
                    ...
                    "categorical_count": analysis_result["categorical_count"],
